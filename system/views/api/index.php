...
<div class="contentContainer" data-theme="light" style="width: 75%; margin: auto;">
    <div class="content">
        ...
        <p class="fontVerdana">If you would like to add a feature to the <?= \WEBSITE_NAME; ?> yourself, please navigate to our <a href="<?= \GITHUB_URL; ?>" target="_blank">Github page</a>.</p>
