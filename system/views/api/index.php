...
<div class="contentContainer" data-theme="light" style="width: 75%; margin: auto;">
    <div class="content">
        ...
        <p class="fontVerdana">When using our API you agree to our <a href="<?php echo \URL; ?>">Terms of Service</a></p>

        <h1>How to use</h1>
        <p class="fontVerdana">Our API uses a GET request system using the following URL format: <code><?php echo \URL; ?>api/CategoryMethod Name/Value/</code></p>

        <h1 class="fontTrebuchet">Methods</h1>
        <ul class="fontVerdana">
            <li>
                <code><?php echo \URL; ?>api/game/get/game id here/</code>
                <ul>
            ...
            <li>
                <code><?php echo \URL; ?>api/strategyguide/get/guide id here/</code>
                <ul>
            ...
            <li>
                <code><?php echo \URL; ?>api/user/get/user id here/</code>
                <ul>
        ...
        <p class="fontVerdana"><code><?php echo \URL; ?>api/strategyguide/get/1/</code></p>
        <pre>
            <code>
                {
                    "success": true,
        ...
        <p class="fontVerdana"><code><?php echo \URL; ?>api/game/</code></p>
        <pre>
            <code>
                {
                    "success": false,
